...
const tiers = [
  {
    ...
    price: "$0",
    period: "forever",
    description: "Everything you need to start coding with AI. No credit card, no API keys required.",
    features: [
      "Full-featured code editor",
      "AI via Gemini, Groq, and DeepSeek (free)",
      "Inline completions and Quick Edit",
      "Windy Sidebar: Chat, Mail, Fly, Voice, Cloud",
      "Voice-to-code (Windy Word)",
      "199-language translation (3,500+ models)",
      "Windy Fly agent (basic operations)",
      "Works fully offline as standalone editor",
      "Cloud sync (5 GB)"
    ],
    cta: "Download Free",
    popular: false
  },
  {
    ...
    features: [
      ...
      "Claude, GPT-4o, Mistral, and premium models",
      "Priority AI completions",
      "Unlimited Windy Fly agent operations",
      "Advanced agent memory and context",
      "10+ providers — switch with one click",
      "Cloud sync (100 GB)",
      "Priority support"
    ],
    cta: "Start Pro",
